...
class SalsaNext(nn.Module):
    def __init__(self, nclasses=3, input_scan=2):
        ...
        print(sum(p.numel() for p in self.downCntx.parameters())/1000000.0)
        print(sum(p.numel() for p in self.downCntx2.parameters())/1000000.0)
        print(sum(p.numel() for p in self.downCntx3.parameters())/1000000.0)
        print('****')
        ...
        print(sum(p.numel() for p in self.resBlock4.parameters())/1000000.0)
        print(sum(p.numel() for p in self.resBlock5.parameters())/1000000.0)
        print('***')
        print(sum(p.numel() for p in self.upBlock1.parameters())/1000000.0)
        print(sum(p.numel() for p in self.upBlock2.parameters())/1000000.0)
        print(sum(p.numel() for p in self.upBlock3.parameters())/1000000.0)
        print(sum(p.numel() for p in self.upBlock4.parameters())/1000000.0)
