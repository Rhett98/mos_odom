...
if __name__ == '__main__':
    ...
    for seq in range(0, 10): # sequences id
        ...
        for i in range(1,3): # residual_image_i

            # Update the value in config to facilitate the iterative loop
            config['num_last_n'] = i
            config['scan_folder'] = f"/home/robot/Repository/data_odometry_velodyne/dataset/sequences/{'%02d'%seq}/velodyne"
            config['pose_file'] = f"/home/robot/Repository/data_odometry_velodyne/dataset/sequences/{'%02d'%seq}/poses.txt"
            config['calib_file'] = f"/home/robot/Repository/data_odometry_velodyne/dataset/sequences/{'%02d'%seq}/calib.txt"
            ...
            config['residual_image_folder'] = f"/home/robot/Repository/data_odometry_velodyne/dataset/sequences/{'%02d'%seq}/residual_images_{i}"
            config['visualization_folder'] = f"/home/robot/Repository/data_odometry_velodyne/dataset/sequences/{'%02d'%seq}/visualization_{i}"
            ic(config)
